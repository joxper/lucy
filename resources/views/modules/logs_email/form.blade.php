...
@section('title', $title.' - LogsEmail')

@section('page-header', '<div class="page-title"><h1>'.trans('modules.LogsEmail').'<small>'.$title.'</small> </h1></div>')
...
@section('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Modules\LogsEmailRequest') !!}
@endsection